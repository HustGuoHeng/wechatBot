...
class wechatBot
{
    ...
    {
        $now_time = time();
        $url = "https://login.weixin.qq.com/cgi-bin/mmwebwx-bin/login?loginicon=true&uuid=" . $this->uuid . "&tip=1&r=" . $now_time . "&_=1452859503803";
        $result = $this->curlRequest($url, false, array(), 30);
